...
public class MapperTestUtils {
  private static final Map<Class<?>, Supplier<?>> PRIMITIVE_TYPES_WITH_VALUES =
      new HashMap<>() {
        {
  ...
  public static <T> T instantiateObjectWithDefaultValues(
      Class<T> target, Parameter... nonDefaultFields)
